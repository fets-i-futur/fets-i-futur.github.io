...
---
{{< remark gran="si" >}}
**L'estudiantat, professorat i personal d'administració, serveis i gestió són cridats a [**elegir el nou director**](https://epsem.upc.edu/ca/escola/eleccions/direccio-epsem-2024 "Pàgina web eleccions") d'UPC Manresa**. La votació serà electrònica i es podrà votar des de qualsevol lloc amb connexió. **L'urna electrònica serà oberta per tothom els dies 26, 27 i 28 de novembre**. 
{{< /remark >}}
...
Tot això passa gràcies a **la feina de les persones**. Les que tenen cura dels edificis i les infraestructures, les que administren els nostres recursos, les que comuniquen les nostres activitats, les que organitzen els nombrosos actes, les que malden per millorar els serveis essencials. L'entusiasme impagable de l'estudiantat. Els investigadors consolidats que estan assolint fites impensables, els lectors que aporten activitat i aire fresc, així com els associats i substituts que ens ajuden a fer viable UPC Manresa amb la seva generositat.
...
- Reintegra **la biblioteca ---un servei clau--- en el mateix espai que l'Escola**, facilitant la millora del servei.
...
{{< figure src="prog-aigen.webp" loading="lazy" >}}
...
* Assumim els [**Objectius de Desenvolupament Sostenible**](https://www.un.org/sustainabledevelopment/es/objetivos-de-desarrollo-sostenible/) com a propis.
...
* Estem compromesos amb els valors del **treball**, l'**honestedat**, l'**equitat**, el **respecte institucional** i la **transparència**.
* Les **relacions institucionals i la projecció externa** són inversions de futur que cal mimar.

## Accions

Aquestes són algunes accions concretes que impulsarem. Es deriven de la visió i de la planificació estratègica 2023-2026 que forma part del sistema de qualitat.
...
* Facilitar l'accés als laboratoris docents i al TechLab a l'estudiantat en règim de **«laboratori obert»**.
* En el marc del projecte [Galàxia Aprenentatge](https://galaxiaprenentatge.upc.edu/ca), **explorar noves estratègies docents** i consolidar les que resultin més efectives.
* Impulsar la oferta de **formació permanent**, explorant les possibilitats que la LOSU ofereix amb les microcredencials universitàries de la mà de la [Fundació Politècnica](https://www.fpc.upc.edu/cat/).
...
* Mantenir el **suport a les associacions d'estudiants** i fomentar la creació de noves associacions que ampliïn l'espectre associatiu.
* Procurar **espai per a que les associacions d'estudiants puguin desenvolupar la seva activitat**.
* Treballar per a que l'**estudiantat participi activament en la vida universitària** i, especialment, als òrgans de representació.
* Fomentar entre l'estudiantat la **vessant més social de l'activitat universitària** com la cooperació a través del [Centre de Cooperació pel Desenvolupament](https://ccd.upc.edu/ca) o els programes d'aprenentatge-servei.
* Potenciar **més espais de campus en el recinte**, que facilitin la distensió i la relació de l'estudiantat, com passa ara a la taula de ping-pong.
...
* Millorar, conjuntament amb la UTG Manresa, els **processos d'incorporació** (*onboarding*) dels nous membres de la plantilla.
* Treballar, conjuntament amb la UTG Manresa, en la **simplificació i mecanització dels processos administratius**.


* Contribuir a l'**avenç de la recerca** que fan els grups d'UPC Manresa i a la seva difusió.
* Actuar com a **agent de promoció** dels grups de recerca de l'Escola en l'acció de relacions institucionals que es fa ordinàriament. 
* Disseminar el **catàleg de serveis a la recerca** del Servei de Biblioteques, de la UTG Manresa i dels Serveis Generals entre el PDI per maximitzar-ne l'aprofitament.


* Intensificar la **promoció de l'oferta de l'Escola**, procurant expandir l'àrea d'influència.
* Reestructurar l'**espai web de l'Escola** per fer-lo més eficaç en les seves funcions. 
...
* Donar suport als departaments de l'Escola per **consolidar la plantilla de PDI**.
...
Professor Titular. Doctor en Matemàtiques. Ha sigut sotsdirector d'estudis durant nou anys; director en funcions d'UPC Manresa durant la crisi de la COVID; sotsdirector de Qualitat a la darrera legislatura. Fa recerca en la Teoria de Jocs. Té passió per les infraestructures ferroviàries i el relaxa la música simfònica.
{{< /fitxa >}}

{{< fitxa foto="dp-iagen.webp" 
          nom="David Parcerisa" 
		  futur="https://futur.upc.edu/DavidParcerisaDuocastella" >}}
Professor Agregat. Doctor en Geologia. Ha sigut professor a la UB, a la UAB a UPC Manresa. Secretari Acadèmic de d'UPC Manresa des de 2014. Responsable d'UPC Alumni i d'Igualtat. Fa recerca en l'àmbit de la petrologia i la geoquímica. Pro-actiu en la difusió de la ciència i la promoció dels estudis de l'Escola. Juga al pickleball i xala amb el senderisme.
{{< /fitxa >}}
...
Professor Titular. Doctor Eng. en Informàtica. Ha sigut professor a la FIB i l'ETSEIB; director de la Càtedra de Programari Lliure de la UPC; Delegat del Rector per la Política TIC i membre del Consell de Direcció de la UPC. Actualment, és sotsdirector de Projectes Estratègics d'UPC Manresa. Te delit per la cuina i es distreu restaurant màquines-eina de qualitat al seu taller.
{{< /fitxa >}}

---

{{< remark >}}
Totes les imatges que conté la pàgina s'han generat amb IA fent servir el model DALL·E3. Algunes a partir d'una descripció textual senzilla. Altres com a transformacions de fotografies reals. Sempre s'ha demanat que segueixin l'estètica manga. De seguida hi veureu les limitacions i els biaixos que la IA té en aquests moments.
{{< /remark >}}
